...
namespace Test3D
{
    public class Solbourg : Level
    {
        ...
        public void Load(ContentManager Content, Effect shader)
        {
            ...
            //this.AddModel(Content, textures, "Solbourg_Muraille", "Muraille_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.004f), new Vector3(-10f, -1, -10f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Puits", "Puits_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.004f), new Vector3(2f, -1, 5f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Buisson", "Buisson_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.006f), new Vector3(11f, -1, 2.05f), Vector3.Up, 0f, ModelType.TwoDimensional, false);
            ...
            //this.AddModel(Content, textures, "Solbourg_Palace", "Palace_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.0015f), new Vector3(0, -1, -10f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Commerce", "Commerce_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.005f), new Vector3(-6, -1, 8f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Restaurant", "Restaurant_1s", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.006f), new Vector3(-8, -1, 0), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, normals, "Solbourg_Chemin", "Chemin_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.01f), new Vector3(-9, -0.99f, 5.75f), Vector3.Up, 0f, ModelType.TwoDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Manoir", "Manoir_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.006f), new Vector3(-20, -1f, 5.5f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Buisson_Taille", "Buisson taillé", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.003f), new Vector3(-5, -1f, 15f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            //this.AddModel(Content, textures, "Solbourg_Cloture", "Cloture_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.003f), new Vector3(-5.4f, -1f, 14f), Vector3.Up, 0f, ModelType.ThreeDimensional, false);
            ...
            //this.AddModel(Content, textures, "Solbourg_Dalle", "Dalles_1", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.002f), new Vector3(-4.3f, -0.99f, 5.5f), Vector3.Up, 90, ModelType.ThreeDimensional, false);
            ...
            //this.AddModel(Content, textures, "Solbourg_Maison_2E", "Maison centre-ville 01", shader, new Material(1, 1, 0, 1), Matrix.CreateScale(0.006f), new Vector3(-5f, -0.99f, -7f), Vector3.Up, 0, ModelType.ThreeDimensional, false);
